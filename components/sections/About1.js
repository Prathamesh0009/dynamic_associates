                        ...
                        <div className="col-lg-12">
                            <div className="about-content hover-box-wrap rmb-55 wow fadeInRight delay-0-2s">
                                <div className="section-title">
                                    ...
                                    <h2><span>Dynamic Associates Software Solutions:</span> Your Premier Partner for Innovative and Comprehensive Digital Services <i className="fas fa-asterisk" /></h2>
                                </div>
