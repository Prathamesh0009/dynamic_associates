                ...
                <section className="page-banner-area pt-135 rpt-95 pb-110 rpb-70 rel z-1 bgs-cover" style={{ backgroundImage: 'url(assets/images/background/banner-bg.png)' }}>
                    <div className="container">
                        <div className="banner-inner text-white wow fadeInUp delay-0-2s">
                            ...
                            <h1 className="page-title style-two">Digital Marketing</h1>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="row gap-50">
                            <div className="col-lg-8">
                                <div className="service-details-content rmb-65 wow fadeInUp delay-0-2s">
                                    <h3>Enhance Your Brand with Advanced Digital Marketing</h3>
                                    <p className="sub-title">Achieve Maximum Online Influence. Drive Results</p>
                                    {/* <h4>Digital Marketing</h4> */}
                                    <p>At Dynamic Associates Software Solutions, we offer advanced digital marketing solutions tailored to amplify your online presence. From SEO and social media management to conversion-focused campaigns, we customize our strategies to meet your goals and ensure measurable results.</p>
                                    <h3>Unlock growth opportunities and connect with your target audience through our advanced digital marketing strategies.</h3>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="service-sidebar">
                                    <div className="widget widget-cta wow fadeInUp delay-0-2s">
                                        ...
                                        <Link href="/callto:+91 8847207402" className="theme-btn style-two w-100">+91 8847207402</Link>
                                    </div>
