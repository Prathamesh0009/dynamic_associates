                ...
                <div>
                            ...
                            <div className="row align-items-end justify-content-between">
                                <div className="col-lg-8 wow fadeInLeft delay-0-2s">
                                    <div className="about-hero-content pt-135 rpt-95 pb-95">
                                        <h1>Innovative <span>IT Solutions</span> for Modern Businesses</h1>
                                        <p>Stay ahead of the competition with our cutting-edge IT solutions. We provide tailored services designed to meet the unique challenges of today’s business environment, ensuring efficiency and growth.</p>
                                ...
                                <div className="col-lg-7">
                                    <div className="about-content wow fadeInRight delay-0-2s">
                                        <div className="section-title mb-30">
                                            <span className="sub-title mb-15">Trusted Innovative IT Solutions for Modern Businesses:</span>
                                            <h2>We’re a digital design studio that connects brands to people through craft and culture, ensuring seamless integration of <span>technology and creativity.</span> <i className="fas fa-asterisk" /></h2>
                                        </div>
                                        {/* <VideoPopup style={2} /> */}
                                    </div>
                                </div>
                            ...
                            <div className="row gap-150 justify-content-between">
                                ...
                                <div className="col-lg-6 pt-35 wow fadeInRight delay-0-2s">
                                    <div className="service-item-four">
                                        <h5>WEBSITE DEVELOPMENT <span className="number">01</span></h5>
                                        <p>Experience our innovative web development services aimed at creating engaging online platforms</p>
                                        <Link href="/services" className="read-more-two">Read More <img src="/assets/images/icons/arrow.svg" alt="Arrow" /></Link>
                                    </div>
                                    <div className="service-item-four">
                                        <h5>SOFTWARE DEVELOPMENT <span className="number">02</span></h5>
                                        <p>Discover our comprehensive software solutions designed to optimize your business operations.</p>
                                        <Link href="/services" className="read-more-two">Read More <img src="/assets/images/icons/arrow.svg" alt="Arrow" /></Link>
                                    </div>
                                    <div className="service-item-four">
                                        <h5>DIGITAL MARKETING <span className="number">03</span></h5>
                                        <p>Explore our effective digital marketing strategies tailored to enhance your online presence</p>
                                        <Link href="/services" className="read-more-two">Read More <img src="/assets/images/icons/arrow.svg" alt="Arrow" /></Link>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="col-lg-6 offset-lg-6 wow fadeInLeft delay-0-2s">
                                        <div className="faq-content-part mb-25 rmb-0">
                                            <div className="section-title mb-35">
                                                <span className="sub-title mb-10">Trusted Web & Software Development</span>
                    ...
                    <div className="lets-talk-area text-center bgs-cover pt-120 pb-130 rpy-90" style={{ backgroundImage: 'url(assets/images/background/tets-talk.jpg)' }}>
                        <div className="container">
                            ...
                            <h5 className="talk-to-email"><Link href="/contact">Contact us</Link> or send an <span>email to</span> <Link href="mailto:Hemant.chauhan@dynamicassociatessoftwaresolution.com">Hemant.chauhan@dynamicassociatessoftwaresolution.com</Link></h5>
                        </div>
                    </div>
                    {/* Lets Talk Area end */}
                </div>
